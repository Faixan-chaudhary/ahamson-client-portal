  ...
  return (
    <div className="">
      <label className={cn(
          ...
          error ? "border-red-500" : (checked ? "border-[#F7931E]/40 bg-[#F7931E]/5" : "border-[#0B1F3A]/10 bg-[#F8F9FC]")
        )}>
        {onCheck !== undefined && (
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-[#0B1F3A]">{label}{required && <span className="text-[#F7931E] ml-0.5">*</span>}</p>
          {fileName && (
        ...
        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-[#0B1F3A]/12 bg-white text-xs font-semibold text-[#0B1F3A] hover:bg-[#F4F6FA] cursor-pointer transition-all flex-shrink-0">
