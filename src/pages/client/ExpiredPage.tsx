...
export function ExpiredPage() {
  return (
    <div className="min-h-screen bg-[#F4F6FA] font-['Inter'] flex flex-col">
      <header className="border-b border-white/10 px-6 py-3.5" style={{ background: `linear-gradient(135deg, ${NAVY}, #162d52)` }}>
        <Logo light />
      </header>
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl border border-[#0B1F3A]/8 overflow-hidden text-center">
          ...
          <div className="p-8">
            ...
            <div className="bg-[#F8F9FC] rounded-xl p-4 text-xs text-[#94A3B8] flex items-center gap-2 justify-center">
              ...
              Links expire after 2 hours for security
            </div>
            <p className="text-xs text-[#94A3B8] mt-6">
              Need help? Contact <span className="text-[#F7931E]">documents@ahamson.com</span>
            </p>
          </div>
        </div>
      </div>
